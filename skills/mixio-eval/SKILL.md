...
```
1. studio_list_projects()                         → resolve the Studio project
...
- The local stdio bridge intentionally has no evaluation or review-project tools; `list_projects` always means `studio_list_projects`.
